...
1. Configure the plugin by going into Training Courses-->Paid Memberships Pro, then associate courses with membership levels (this assumes you already have courses and membership levels created).
...
Click here to get [Paid Memberships Pro](http://www.paidmembershipspro.com/).
